...
if __name__ == '__main__':
    ...
    # freeze some layers
    trainable_layer_names = ['separable_conv2d_37', 'separable_conv2d_48', 'separable_conv2d_38', 'separable_conv2d_49']
    for layer in model.layers:
        if not layer.name in trainable_layer_names:
    ...
    # get data generator
    train_gen = Datagenerator(trainset, batch_size)
    val_gen = Datagenerator(valset, batch_size)
